...
#train dir
train_dir= './archive/images_balanced/train_balanced'
...
for epoch in range(epochs):
    ...
    if val_epoch_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), './checkpoints/best_model_emotion_6cls_balanced.pth')
        print(f"✅ Saved new best model with Val Acc: {best_val_acc:.2f}%")


torch.save(model.state_dict(), './checkpoints/emotion_model_6cls_2.pth')
